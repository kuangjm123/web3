...
public class Web3jConfig {
    ...
    @Value("${kjm.token.contract.address}")
    ...
    @Bean
    public KJMTokenService kjmTokenService(Web3j web3j, Credentials credentials) {
        return new KJMTokenService(web3j, credentials, contractAddress);
    }
}